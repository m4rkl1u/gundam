...
import time
import tiktoken
from datasets import load_dataset, DownloadMode # huggingface datasets
import fire
...
def prepare_data(path = path, name = name, test_size = test_size, seed = int(time.time())):

    # takes 54GB in huggingface .cache dir, about 8M documents (8,013,769)
    dataset = load_dataset(path, name, num_proc=num_proc_load_dataset)#, download_mode = DownloadMode.FORCE_REDOWNLOAD)
